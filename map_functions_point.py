...
def get_rainfall_interpolate(folder = "/home/leon/Doutorado/SIR/maps/precipitation-mean",
    ...
    '''
    if (os.path.exists("maps/list_of_maps_precipitation_mean_day_point_{0}.npy".format(city))):
        list_of_maps = np.load("maps/list_of_maps_precipitation_mean_day_point_{0}.npy".format(city))
    else:
        ...
        np.save("maps/list_of_maps_precipitation_mean_day_point_{0}.npy".format(city), list_of_maps)
...
def get_temp_interpolate(temp_day_folder = "/home/leon/Doutorado/SIR/maps/LST_Day",
    ...
    '''
    if (os.path.exists("maps/list_of_maps_temperature_day_point_{0}.npy".format(city))):
        list_of_maps = np.load("maps/list_of_maps_temperature_day_point_{0}.npy".format(city))
    else:
        ...
        np.save("maps/list_of_maps_temperature_day_point_{0}.npy".format(city), list_of_maps)
